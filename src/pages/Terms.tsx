          ...
          <div className="container mx-auto px-6 max-w-4xl">
            <Reveal>
              ...
              <div className="prose prose-invert prose-purple max-w-none text-gray-300">
                ...
                <h2 className="text-2xl font-semibold text-white mt-8 mb-4">2. Use of Services</h2>
                <p className="mb-4">
                ...
                <h2 className="text-2xl font-semibold text-white mt-8 mb-4">3. Account & Security</h2>
                <p className="mb-4">
