      ...
      {isOpen && (
        <div className="fixed inset-0 z-[80] flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
          ...
          <motion.div
            ...
            className="relative z-10 w-full max-w-4xl overflow-hidden rounded-3xl border border-line bg-paper shadow-2xl my-auto text-carbon"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Header Action Bar */}
            <div className="flex items-center justify-between border-b border-line px-6 py-4 bg-paper/90 backdrop-blur-sm">
            ...
            {/* Modal Body */}
            <div className="grid md:grid-cols-12 gap-8 p-6 sm:p-10 max-h-[80vh] overflow-y-auto">
              ...
              {/* Right Column: Name, Role, Bio, Competencies, Projects */}
